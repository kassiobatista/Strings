...
User Function Strings()
    ...
    cResp       := RTRIM(cTexto2) //Remove espaÃ§os a direita
    ...
    cResp       := Tranform(cTexto1, "@R99.999.999/9999-99") // Pode pesquisar por pictures do Protheus e brincar com essa função
